...
var VirtualSelect = /*#__PURE__*/function () {
  ...
  virtual_select_createClass(VirtualSelect, [{
    ...
    value: function setEleProps() {
	  ...
	  $ele.removeOption = VirtualSelect.removeOptionMethod;
    ...
    key: "removeOption",
      ...
      this.options.splice(index, 1);
          ...
          console.log(this.lastOptionIndex);
    }
  }, {
    key: "removeNewOption",
    ...
    key: "removeOptionMethod",
    value: function removeOptionMethod(index) {
      this.virtualSelect.removeOption(index);
    }
  }, {
